...
const { SQLServerColumnEncryptionAzureKeyVaultProvider } = require('../../../src/always-encrypted/SQLServerColumnEncryptionAzureKeyVaultProvider');

describe('SQLServerColumnEncryptionAzureKeyVaultProvider', () => {
  ...
  it('constructs', () => {
    const keyVaultProvider = new SQLServerColumnEncryptionAzureKeyVaultProvider('sampleClientId', 'sampleClientKey', 'sampleTenantId');
