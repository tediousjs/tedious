...
describe('integer-data-types', function() {
  describe('int data type test', function() {
    ...
    params.forEach(function(item) {
      it('test valid parameter values', function() {
        const buffer = Buffer.concat([...Int.generateParameterData(item.param, options) as Generator<Buffer, void>]);
  ...
  describe('small int data type test', function() {
    ...
    params.forEach(function(item) {
      it('test valid parameter values', function() {
        const buffer = Buffer.concat([...SmallInt.generateParameterData(item.param, options) as Generator<Buffer, void>]);
  ...
  describe('tiny int data type test', function() {
    ...
    params.forEach(function(item) {
      it('test valid parameter values', function() {
        const buffer = Buffer.concat([...TinyInt.generateParameterData(item.param, options) as Generator<Buffer, void>]);
  ...
  describe('big int data type test', function() {
    ...
    params.forEach(function(item) {
      it('test valid parameter values', function() {
        const buffer = Buffer.concat([...BigInt.generateParameterData(item.param, options) as Generator<Buffer, void>]);
