var convertLEBytesToString = require('../../../src/tracking-buffer/bigint')
  .convertLEBytesToString;
var numberToInt64LE = require('../../../src/tracking-buffer/bigint')
  .numberToInt64LE;
...
module.exports.toInt64LE = function(test) {
  assertBuffer(test, numberToInt64LE(-3500000000), [
    0x00,
    0x3d,
    0x62,
    0x2f,
  ...
  assertBuffer(test, numberToInt64LE(-2), [
    0xfe,
    0xff,
    0xff,
    0xff,
  ...
  assertBuffer(test, numberToInt64LE(0), [
    0x00,
    0x00,
    0x00,
    0x00,
  ...
  assertBuffer(test, numberToInt64LE(-5000000000), [
    0x00,
    0x0e,
    0xfa,
    0xd5,
  ...
  assertBuffer(test, numberToInt64LE(5201683247893), [
    0x15,
    0x73,
    0x7b,
    0x1c,
...
var assertBuffer = function(test, actual, expected) {
  return (() => {
    var result = [];
    for (
      var i = 0, end = actual.length - 1, asc = 0 <= end;
      asc ? i <= end : i >= end;
      asc ? i++ : i--
    ) {
      let item;
