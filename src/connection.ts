...
import { InternalConnectionOptions, ConnectionOptions } from './connection-options';
export { InternalConnectionOptions } from './connection-options';
...
class Connection extends EventEmitter {
  ...
  constructor(config: ConnectionConfiguration) {
    ...
    this.config = {
      ...
      options: new InternalConnectionOptions(config.options)
    };

    this.secureContext = createSecureContext(this.config.options.cryptoCredentialsDetails);
