...
export type ParserOptions = Pick<InternalConnectionOptions, 'useUTC' | 'lowerCaseGuids' | 'tdsVersion' | 'useColumnNames' | 'columnNameReplacer' | 'camelCaseColumns' | 'alwaysEncrypted' | 'encryptionKeyStoreProviders' | 'columnEncryptionKeyCacheTTL'> & {
  /**
