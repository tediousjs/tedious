...
function options(config) {
  ...
  this.config = {
    ...
    options: {
      ...
      enableConcatNullYeldsNull: true,
  ...
  if (config.options) {
    ...
    if (config.options.enableConcatNullYeldsNull != undefined) {
      if (typeof config.options.enableConcatNullYeldsNull !== 'boolean') {
        throw new TypeError('options.enableConcatNullYeldsNull must be a boolean (true or false).');
      }

      this.config.options.enableConcatNullYeldsNull = config.options.enableConcatNullYeldsNull;
    }
...
class Connection extends EventEmitter {
  ...
  getInitialSql() {
    ...
    const enableConcatNullYeldsNull = this.config.options.enableConcatNullYeldsNull ? 'on' : 'off';
    ...
    return `set textsize ${this.config.options.textSize}\n
      ...
      set ansi_nulls ${enableAnsiNull}\n
      set ansi_null_dflt_on ${enableAnsiNullDefault}\n
      set concat_null_yields_null ${enableConcatNullYeldsNull}\n
