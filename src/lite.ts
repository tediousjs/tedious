...
import Connection, { type ConnectionConfiguration, type DefaultAuthentication, type ConnectionOptions } from './connection-lite';
...
type ConnectionAuthentication = DefaultAuthentication
